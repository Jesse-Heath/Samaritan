...
page.open(url, function(status) {
    ...
    page.viewportSize = { width: 1200, height: 2048 };

    console.log('wait');
    setTimeout(function() {
        //the clipRect is the portion of the page you are taking a screenshot of
        var main = page.evaluate(function(){
            return document.querySelector('.content-container-aside > .list-group.media-list.media-list-stream').getBoundingClientRect();
        });
